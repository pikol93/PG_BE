...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'mysql', 'port' => '3306', 'dbname' => 'be_188581_db', 'user' => 'root', 'password' => 'student', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('OLLyEmsoOroV39KS5X7VSL4g9SDxiqn9CCBFnFt9U748GxGIOI8WRCDbhQYcjuUa'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('OLLyEmsoOroV39KS5X7VSL4g9SDxiqn9CCBFnFt9U748GxGIOI8WRCDbhQYcjuUa');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                3 => ($this->targetDirs[3].'/modules/gridhtml/translations'),
                ...
                43 => ($this->targetDirs[3].'/modules/psgdpr/translations'),
                44 => ($this->targetDirs[3].'/modules/ps_mbo/translations'),
                ...
                49 => ($this->targetDirs[3].'/modules/dashproducts/translations'),
                50 => ($this->targetDirs[3].'/modules/statssales/translations'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => 'OLLyEmsoOroV39KS5X7VSL4g9SDxiqn9CCBFnFt9U748GxGIOI8WRCDbhQYcjuUa',
